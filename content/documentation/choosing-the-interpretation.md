...
Oasys allows you to remove parts of a record (for example, if the patient is ill for 3 days of a 4 week record, it is possible to remove these 3 days). See the section on adding comments for more details on how to do this.
...
The Oasys report will always include some analysis of the different exposures in a record, however the bulk of the report only analyses the ticked work exposures. Any exposures that are not considered to be exposed to the suspected causative agent should be unticked in this list.