...
If something has gone wrong and you end up with multiple patient details file, you can combine them by [exporting patient details](/documentation/exporting-patient-details) and [importing patient details](/documentation/importing-patient-details).