---
title: "Deleting patients and records"
date: 2026-01-22T00:00:00+01:00
draft: false
description: "Deleting patients and records"
---

You can remove patients and records from your patient details file. This can be useful if you have entered the same patient twice, for example.
...
The right hand side shows all the serial peak flow records in your patient details file. Tick each record that you wish to remove. You may want to scroll right to see the start and end dates of the records. If you tick all the records for a patient the patient will automatically be ticked as well. You can manually untick the patient if you require, and then you will still be able to create new records and enter audit / clinical details for the patient.
