---
title: "The Oasys Report"
date: 2026-01-22T00:00:00+01:00
draft: false
description: "The Oasys report"
---

The Oasys report shows the results of the Oasys Analysis of the record. Computer analysis can never replace an expert opinion and for this reason the Oasys scores of occupational asthma make up only a small part of the report. Much of the rest of the report shows graphs that we find useful in diagnosing occupational asthma.

To open the report click on "View - Report". The report is also the place to [add comments](/documentation/adding-comments) and [add opinions](/documentation/adding-opinions).
